...
const CurrentDisplay: React.FC<Props> = ({variant, outerToDo, inputField, setinputField, handleAddInnerItem, updateProgress, outerToDoList, setOuterToDoList, handleSetDueDateClicked}) => {
